...
M2M2_PM_SYS_COMMAND_ENUM_t = {
  ...
  "enum_values": [
    ...
    (M2M2_PM_SYS_COMMAND_ENABLE_GEN_BLK_DCB_LOAD_REQ",        0x8C),
    (M2M2_PM_SYS_COMMAND_ENABLE_GEN_BLK_DCB_LOAD_RESP",       0x8D),
    (M2M2_PM_SYS_COMMAND_DISABLE_GEN_BLK_DCB_LOAD_REQ",       0x8E),
    (M2M2_PM_SYS_COMMAND_DISABLE_GEN_BLK_DCB_LOAD_RESP",      0x8F),
    (M2M2_PM_SYS_COMMAND_SYSTEM_HW_RESET_REQ",                0x90),
    (M2M2_PM_SYS_COMMAND_SYSTEM_HW_RESET_RESP",               0x91),
    ]
}
