...
enum M2M2_EDA_APP_CMD_ENUM_t:uint8_t {
  ...
  M2M2_EDA_APP_CMD_GET_RTIA_TABLE_FDS_REQ = 88,
  M2M2_EDA_APP_CMD_GET_RTIA_TABLE_FDS_RESP = 89,
  M2M2_EDA_APP_CMD_GET_RTIA_TABLE_RAM_REQ = 90,
  M2M2_EDA_APP_CMD_GET_RTIA_TABLE_RAM_RESP = 91,
  M2M2_EDA_APP_CMD_DELETE_RTIA_TABLE_IN_FDS_REQ = 92,
  M2M2_EDA_APP_CMD_DELETE_RTIA_TABLE_IN_FDS_RESP = 93,
  M2M2_EDA_APP_CMD_HARDWARE_INFO_REQ = 94,
  M2M2_EDA_APP_CMD_HARDWARE_INFO_RESP = 95,
};
...
struct eda_app_hardware_info_t {
  uint8_t  command; 
  uint8_t  status; 
  uint32_t  lowoscillatorfreq; 
};
...
struct eda_app_get_rtia_table_t {
  uint8_t  command; 
  uint8_t  status; 
};

struct eda_app_delete_rtia_table_t {
  uint8_t  command; 
  uint8_t  status; 
};
