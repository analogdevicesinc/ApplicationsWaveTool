...
#define MAXBIADCBDCFGSIZE	11
#define MAXBIADCBLCFGSIZE	27
#define MAXECGDCBSIZE	4
#define MAXEDADCBDCFGSIZE	9
#define MAXEDADCBLCFGSIZE	3
...
enum M2M2_AD5940_DCB_DATA_FLAG_t:uint8_t {
  ADI_DCB_AD5940_LCFG_ENABLE = 0,
  ADI_DCB_AD5940_DCFG_ENABLE = 1,
  ADI_DCB_MAX_AD5940_BLOCK_IDX = 2,
  ADI_DCB_INVALID = 3,
};
static_assert(sizeof(M2M2_AD5940_DCB_DATA_FLAG_t) == 1, "Enum 'M2M2_AD5940_DCB_DATA_FLAG_t' has an incorrect size!");
...
enum M2M2_DCB_CONFIG_BLOCK_INDEX_t:uint8_t {
  ...
  ADI_DCB_BIA_LCFG_BLOCK_IDX = 16,
  ADI_DCB_BIA_DCFG_BLOCK_IDX = 17,
  ADI_DCB_EDA_DCFG_BLOCK_IDX = 18,
  ADI_DCB_MAX_BLOCK_IDX = 19,
};
...
struct m2m2_dcb_cmd_t {
  uint8_t  command; 
  uint8_t  status; 
  M2M2_DCB_CONFIG_BLOCK_INDEX_t  dcb_blk_idx;
};
...
struct m2m2_dcb_eda_lcfg_data_t {
  uint8_t  command; 
  uint8_t  status; 
  M2M2_DCB_CONFIG_BLOCK_INDEX_t  dcb_blk_idx;
  uint8_t  size;   
  uint32_t  lcfgdcbdata[3]; 
};

struct m2m2_dcb_eda_dcfg_data_t {
    uint8_t  command;
    uint8_t  status;
    M2M2_DCB_CONFIG_BLOCK_INDEX_t  dcb_blk_idx;
    uint8_t  size;
    uint64_t  dcfgdcbdata[9];
};

struct m2m2_dcb_bia_lcfg_data_t {
  uint8_t  command; 
  uint8_t  status; 
  M2M2_DCB_CONFIG_BLOCK_INDEX_t  dcb_blk_idx;
  uint8_t  size; 
  uint32_t  lcfgdcbdata[27];
};

struct m2m2_dcb_bia_dcfg_data_t {
    uint8_t  command;
    uint8_t  status;
    M2M2_DCB_CONFIG_BLOCK_INDEX_t  dcb_blk_idx;
    uint8_t  size;
    uint64_t  dcfgdcbdata[11];
};
...
struct m2m2_dcb_block_status_t {
  uint8_t  command; 
  uint8_t  status; 
  uint8_t  dcb_blk_array[19]; 
};

struct m2m2_dcb_ad5940_state_t {
  uint8_t  command; 
  uint8_t  status; 
  M2M2_DCB_CONFIG_BLOCK_INDEX_t  dcb_state;
};
