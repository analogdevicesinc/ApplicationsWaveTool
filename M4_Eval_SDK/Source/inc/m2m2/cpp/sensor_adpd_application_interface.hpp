...
enum M2M2_SENSOR_ADPD_COMMAND_ENUM_t:uint8_t {
  ...
  M2M2_SENSOR_ADPD_COMMAND_GET_CTR_REQ = 75,
  M2M2_SENSOR_ADPD_COMMAND_GET_CTR_RESP = 76,
  M2M2_SENSOR_ADPD_COMMAND_FLOATMODE_CFG_REQ = 77,
  M2M2_SENSOR_ADPD_COMMAND_FLOATMODE_CFG_RESP = 78,
  M2M2_SENSOR_ADPD_COMMAND_SET_DARK_OFFSET_RESP = 96,
  M2M2_SENSOR_ADPD_COMMAND_DO_TEST1_REQ = 97,
  M2M2_SENSOR_ADPD_COMMAND_DO_TEST1_RESP = 98,
  M2M2_SENSOR_ADPD_COMMAND_DO_TEST2_REQ = 99,
  M2M2_SENSOR_ADPD_COMMAND_DO_TEST2_RESP = 100,
  M2M2_SENSOR_ADPD_COMMAND_DO_TEST3_REQ = 101,
  M2M2_SENSOR_ADPD_COMMAND_DO_TEST3_RESP = 102,
  M2M2_SENSOR_ADPD_COMMAND_SET_PAUSE_REQ = 103,
  M2M2_SENSOR_ADPD_COMMAND_SET_PAUSE_RESP = 104,
  M2M2_SENSOR_ADPD_COMMUNICATION_MODE_REQ = 105,
  M2M2_SENSOR_ADPD_COMMUNICATION_MODE_RESP = 106,
  M2M2_SENSOR_ADPD_COMMAND_SET_SLOT_ACTIVE_REQ = 107,
  M2M2_SENSOR_ADPD_COMMAND_SET_SLOT_ACTIVE_RESP = 108,
  M2M2_SENSOR_ADPD_COMMAND_GET_SLOT_ACTIVE_REQ = 109,
  M2M2_SENSOR_ADPD_COMMAND_GET_SLOT_ACTIVE_RESP = 111,
  M2M2_SENSOR_ADPD_COMMAND_GET_EFUSE_REQ = 112,
  M2M2_SENSOR_ADPD_COMMAND_GET_EFUSE_RESP = 113,
};
...
enum M2M2_SENSOR_ADPD_DEVICE_ID_ENUM_t:uint8_t {
  ...
  M2M2_SENSOR_ADPD_DEVICE_144 = 12,
  M2M2_SENSOR_ADPDCL_DEVICE_4000 = 40,
  M2M2_SENSOR_ADPDCL_DEVICE_4100 = 41,
};
...
struct m2m2_sensor_adpdCl_slot_resp_t {
  uint8_t  command; 
  uint8_t  status; 
  uint8_t  slot_num; 
  uint8_t  slot_enable; 
...
struct m2m2_sensor_adpdCl_slot_active_resp_t {
  uint8_t  command; 
  uint8_t  status; 
  uint8_t  slot_num; 
  uint8_t  slot_active; 
...
struct m2m2_sensor_adpdCl_resp_t {
  uint8_t  command; 
  uint8_t  status; 
  M2M2_SENSOR_ADPD_DEVICE_ID_ENUM_t  deviceid; 
  uint16_t  retdata[5]; 
